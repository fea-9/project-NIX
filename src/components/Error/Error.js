...
export default ({ title = "ERROR", description }) => (
  <div className="error-template">
    <div className="err-container">
      <div className="err-main-graphic">
        <svg className="err-cog" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
      ...
      <h1 className="err-main-title">{title}</h1>
      <p className="err-main-description">
        {description}
      </p>
    </div>
  </div>
